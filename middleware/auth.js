...
// 🚨 CORRECCIÓN CRÍTICA: Definir un fallback para el secreto si no está en las variables de entorno.
...
exports.protect = async (req, res, next) => {
    ...
    try {
        ...
        // 3. Buscar el usuario en la BD (para asegurar que no ha sido eliminado)
